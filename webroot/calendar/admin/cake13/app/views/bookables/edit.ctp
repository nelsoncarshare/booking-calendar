...
<?php echo $this->Form->create('Bookable');?>
	<fieldset>
		<legend><?php __('Edit Bookable'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Bookable.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Bookable.id'))); ?></li>
