...
<?php echo $this->Form->create('Invoiceextraitem');?>
	<fieldset>
		<legend><?php __('Edit Invoiceextraitem'); ?></legend>
	<?php
...
//		echo $this->Form->input('acnt_code');
		...
		echo $this->Form->select('acnt_code_new', $chartofaccounts, $data['Invoiceextraitem']['acnt_code_new']);
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Invoiceextraitem.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Invoiceextraitem.id'))); ?></li>
