<div class="invoiceextraitems index">
	<h2><?php __('Invoiceextraitems');?></h2>
	...
	<tr<?php echo $class;?>>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $invoiceextraitem['Invoiceextraitem']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $invoiceextraitem['Invoiceextraitem']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $invoiceextraitem['Invoiceextraitem']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $invoiceextraitem['Invoiceextraitem']['id'])); ?>
		</td>
