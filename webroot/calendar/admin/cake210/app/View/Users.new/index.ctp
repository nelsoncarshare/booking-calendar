<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('accountingname'); ?></th>
			...
			<th><?php echo $this->Paginator->sort('licenseExpiresOn'); ?></th>
			<th><?php echo $this->Paginator->sort('acnt_code_customer'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['accountingname']); ?>&nbsp;</td>
		...
		<td><?php echo h($user['User']['lastNoticeSentOn']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['licenseExpiresOn']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['acnt_code_customer']); ?>&nbsp;</td>
		<td class="actions">
