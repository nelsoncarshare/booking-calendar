...
<?php echo $this->Form->create('Vehicle'); ?>
	...
	<?php
		...
		echo $this->Form->select('acnt_code_gas', $chartofaccounts);
		echo $this->Form->select('acnt_code_admin', $chartofaccounts);
		echo $this->Form->input('acnt_code_repair', array('type' => 'select', 'options' => $chartofaccounts));
