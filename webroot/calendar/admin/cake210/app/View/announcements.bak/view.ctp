...
<h2><?php echo __('Announcement');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Display On Day'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete Announcement'), array('action' => 'delete', $announcement['Announcement']['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $announcement['Announcement']['id'])); ?> </li>
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				...
				<?php echo $this->Html->link(__('Delete'), array('controller' => 'announcementdates', 'action' => 'delete', $announcementdate['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $announcementdate['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
