...
<ul class="actions">
<li><?php echo $this->html->link('Delete','/grouptypes/delete/' . $html->tagValue('Grouptype/id'), null, 'Are you sure you want to delete: id ' . $html->tagValue('Grouptype/id'));?>
<li><?php echo $this->html->link('List Grouptypes', '/grouptypes/index')?></li>
<li><?php echo $this->html->link('View Groups', '/groups/index/');?></li>
<li><?php echo $this->html->link('Add Groups', '/groups/add/');?></li>
</ul>
