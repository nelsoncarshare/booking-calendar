...
<?php echo $this->Form->create('Invoiceextraitem');?>
	<fieldset>
		<legend><?php echo __('Edit Invoiceextraitem'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete'), array('action' => 'delete', $this->Form->value('Invoiceextraitem.id')), null, sprintf(__('Are you sure you want to delete # %s?'), $this->Form->value('Invoiceextraitem.id'))); ?></li>
