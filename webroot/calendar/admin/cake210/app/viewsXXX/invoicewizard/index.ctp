...
<div>
		...
		<ul>
			...
			<li><?php echo $this->html->link('Position Locations On Map','../../../index.php?action=edit_vehicle_locations')?></a>
			</ul>
		...
		<ul>
			<li><?php echo $this->html->link('Administer bookings','../../../index.php?action=car_month_usage_form')?></a>
		</ul>		
		<br/>
		<br/>
		<b>Billing</b>
		<p align='center'>
			<ul>
				<li><?php echo $this->html->link('List invoices for user','../../../index.php?action=list_invoices_form')?></a>		
			</ul>
			<br/>
			<br/>
			<ol>
				...
				<li><?php echo $this->html->link('Preview invoices','../../../index.php?action=preview_invoice_form')?></a>
				<li><?php echo $this->html->link('Generate Invoices, Create IIF files, Email to members','../../../index.php?action=generate_invoices_form')?></a>
				<li>Remember to make a quickbooks backup so we can backout changes
				<li><?php echo $this->html->link('Download IIF files for generated invoices','../../../index.php?action=list_invoices_form')?></a>
