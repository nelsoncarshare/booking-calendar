...
{
	global $db;
	$query = "select ".SQL_PREFIX."bookables.name as description, ".SQL_PREFIX."locations.id as id, GPS_coord_x as lat, GPS_coord_y as lng, imagefile as icon from ".
