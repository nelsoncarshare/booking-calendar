...
if(isset($_SERVER["HTTPS"]) and $_SERVER["HTTPS"] == "on") $phpc_protocol = "https";
...
if(!file_exists($phpc_root_path . 'custom/config.php')) {
...
function Synch_DB_Timezone_With_PHP($con){
	$now = new DateTime();
